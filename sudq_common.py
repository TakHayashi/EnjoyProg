#sudq_common.py
#common Sudoku problem for performance comparison between solvers.
#selected from program generated problems.
#difficulty: below average=level 2 in ( 1 easy to 5 hard )
